...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_risk_forecasts_id'), 'risk_forecasts', ['id'], unique=False)
    op.create_table('technical_debt_reports',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('repo_id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_technical_debt_reports_id'), 'technical_debt_reports', ['id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_technical_debt_reports_id'), table_name='technical_debt_reports')
