...
export default function LoginPage() {
  ...
  const handleStubLogin = () => {
    window.location.href = '/login/callback?code=stub_code';
  };
    ...
    <div className="flex h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-sm rounded-xl border bg-card p-8 shadow-sm space-y-6">
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <Button onClick={handleStubLogin} variant="outline" className="w-full" size="lg">
            Bypass with Local Stub (Offline)
          </Button>
        </div>
      </div>
    </div>
