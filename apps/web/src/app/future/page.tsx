...
export default function FutureIntelligencePage() {
                        ...
                        const [timeMachineHorizon, setTimeMachineHorizon] =
                                                useState<string>('1_year');
                        const [analyzing, setAnalyzing] = useState(false);

                        const timeMachineSnapshots: Record<
                                                string,
                                                {
                                                                        label: string;
                                                                        buildings: {
                                                                        ...
                                                                        buildings: [
                                                                                                {
                                                                                                                        name: 'Auth Service',
                                                                                                                        height: 65,
                                                                                                                        glow: 'border-amber-500/80 shadow-amber-500/30',
                                                                                                                        color: 'bg-amber-500',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Payment Gateway',
                                                                                                                        height: 85,
                                                                                                                        glow: 'border-amber-500 shadow-amber-500/40',
                                                                                                                        color: 'bg-amber-500',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Checkout API',
                                                                        ...
                                                                        buildings: [
                                                                                                {
                                                                                                                        name: 'Auth Service',
                                                                                                                        height: 95,
                                                                                                                        glow: 'border-rose-500 shadow-rose-500/50',
                                                                                                                        color: 'bg-rose-500',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Payment Gateway (Legacy)',
                                                                                                                        height: 110,
                                                                                                                        glow: 'border-rose-600 shadow-rose-600/60 ring-2 ring-rose-500',
                                                                                                                        color: 'bg-rose-600',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Checkout Microservice (New)',
                                                                                                                        height: 40,
                                                                                                                        glow: 'border-indigo-500 shadow-indigo-500/50',
                                                                                                                        color: 'bg-indigo-500',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Analytics Worker',
                                                                                                                        height: 60,
                                                                                                                        glow: 'border-amber-500',
                                                                                                                        color: 'bg-amber-500',
                                                                                                },
                                                                        ],
                                                ...
                                                '3_years': {
                                                                        ...
                                                                        buildings: [
                                                                                                ...
                                                                                                },
                                                                                                {
                                                                                                                        ...
                                                                                                                        height: 110,
                                                                                                                        glow: 'border-indigo-500',
                                                                                                                        color: 'bg-indigo-500',
                                                                                                },
                                                                                                {
                                                                                                                        name: 'Sharded Postgres Cluster',
                                                                                                                        height: 140,
                                                                                                                        glow: 'border-cyan-500 shadow-cyan-500/50',
                                                                                                                        color: 'bg-cyan-500',
                                                                                                },
                                                                        ],
                                                                        ...
                                                                        buildings: [
                                                                                                {
                                                                                                                        ...
                                                                                                                        height: 180,
                                                                                                                        glow: 'border-purple-500 shadow-purple-500/60 ring-2 ring-purple-500',
                                                                                                                        color: 'bg-purple-500',
                                                                                                },
                                                                                                {
                        ...
                        const failureOrderPrediction = [
                                                ...
                                                },
                                                {
                                                                        ...
                                                                        probability: '45.0%',
                                                                        cause: 'Memory Pressure Saturation (88%)',
                                                                        impact: '$45K / hr',
                                                },
                                                {
                                                                        rank: 3,
                                                                        ...
                                                                        probability: '28.5%',
                                                                        cause: 'Kafka Consumer Lag Backlog',
                                                                        impact: '$12K / hr',
                                                },
                        ];
                        ...
                        const techDebtUnmaintainable = [
                                                {
                                                                        repo: 'legacy-payment-service',
                                                                        currentScore: 42.0,
                                                                        projected12m: 22.5,
                                                                        status: 'CRITICAL_REWRITE_NEEDED',
                                                                        timeline: 'Within 4 months',
                                                },
                                                {
                                                                        repo: 'analytics-batch-worker',
                                                                        currentScore: 58.4,
                                                                        projected12m: 41.0,
                        ...
                        const growthCostTrajectory = [
                                                {
                                                                        period: 'Current',
                                                                        cost: '$4,820 / mo',
                                                                        drivers: 'EKS Worker Nodes + Provisioned RDS',
                                                },
                                                {
                                                                        period: '12 Months',
                                                                        cost: '$8,450 / mo',
                                                                        drivers: 'Auto-scaled Compute & Storage Expansion',
                                                },
                                                {
                                                                        period: '24 Months',
                                                                        cost: '$14,200 / mo',
                                                                        drivers: 'Multi-region Redundancy & Traffic Surges',
                                                },
                        ];
                        ...
                        const repoFutureHorizons = [
                                                {
                                                                        period: '6 Months',
                                                                        forecast: '+12.4% LOC',
                                                                        warning: 'Auth Vault token validation throughput saturation at 15K QPS',
                                                },
                                                {
                                                                        period: '1 Year',
                                                                        forecast: '+28.5% LOC',
                                                                        warning: 'Legacy Payment Gateway DB pool exhaustion under 2x surge',
                                                },
                                                {
                                                                        period: '3 Years',
                                                                        forecast: '+84.0% LOC',
                                                                        warning: 'Monolithic relational DB schema write IOPS saturation requiring sharding',
                                                },
                                                {
                                                                        period: '5 Years',
                                                                        forecast: '+185.0% LOC',
                                                                        warning: 'Core monolith architecture exceeds maintainability SLA thresholds',
                                                },
                        ];
                        ...
                        const failureChainSteps = [
                                                {
                                                                        step: 1,
                                                                        svc: 'Postgres Primary DB',
                                                                        impact: 'Connection Pool Saturation (100%)',
                                                                        time: '0s',
                                                },
                                                {
                                                                        step: 2,
                                                                        svc: 'legacy-payment-gateway',
                                                                        impact: 'Thread Exhaustion (1800ms p95)',
                                                                        time: '+4s',
                                                },
                                                {
                                                                        step: 3,
                                                                        svc: 'checkout-api',
                                                                        impact: 'HTTP 504 Timeout & Circuit Trip',
                                                                        time: '+12s',
                                                },
                                                {
                                                                        step: 4,
                                                                        svc: 'AWS ALB Ingress',
                                                                        impact: '14.2% HTTP 5xx Error Surge',
                                                                        time: '+25s',
                                                },
                        ];
                        ...
                        const techObsolescenceItems = [
                                                {
                                                                        tech: 'Python 3.8 / FastAPI v0.68',
                                                                        status: 'EOL October 2026',
                                                                        action: 'Migrate to Python 3.12 + FastAPI 0.110+',
                                                },
                                                {
                                                                        tech: 'PyYAML v5.3.1',
                                                                        status: 'Critical CVE Vulnerability',
                                                                        action: 'Upgrade to PyYAML >= 6.0 immediately',
                                                },
                        ];
                        ...
                        const scalingTimelineData = [
                                                {
                                                                        tier: '100K Users',
                                                                        state: 'Single Postgres + Redis 3-node + Monolith',
                                                                        status: 'Baseline',
                                                },
                                                {
                                                                        tier: '500K Users',
                                                                        state: 'Postgres Read Replicas + Redis 6-node',
                                                                        status: '6 Months',
                                                },
                                                {
                                                                        tier: '1M Users',
                                                                        state: 'Extract Checkout & Auth Microservices',
                                                                        status: '12 Months',
                                                },
                                                {
                                                                        tier: '5M Users',
                                                                        state: 'Multi-Region Sharded Postgres + Edge CDN',
                                                                        status: '24 Months',
                                                },
                                                {
                                                                        tier: '50M Users',
                                                                        state: 'Global Autonomous Event Mesh + AI Agents',
                                                                        status: '5 Years',
                                                },
                        ];
                        ...
                        const experimentComparison = {
                                                ...
                                                optionB: {
                                                                        name: 'Option B: Microservices + Event Bus',
                                                                        qps: '180,000 QPS',
                                                                        latency: '18ms p95',
                                                                        cost: '$84K',
                                                },
                                                                                                                        ...
                                                                                                                        {futureTimeline.map(
                                                                                                                                                (
                                                                                                                                                                        ...
                                                                                                                                                                        >
                                                                                                                                                                                                ...
                                                                                                                                                                                                <span
                                                                                                                                                                                                                        className={`text-[10px] font-bold px-2 py-0.5 rounded border inline-block mb-3 ${item.color}`}
                                                                                                                                                                                                >
                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                item.status
                                                                                                                                                                                                                        }
                                                                                                                                                                                                ...
                                                                                                                                                                                                <ul className="space-y-1.5 text-xs text-slate-300">
                                                                                                                                                                                                                        {item.events.map(
                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                                                                <span className="text-indigo-400 text-sm leading-none">
                                                                                                                                                                                                                                                                                                                        •
                                                                                                                                                                                                                                                                                                </span>
                                                                                                                                                                                                                                                                                                <span>
                                                                                                                                                                                                                                                                                                                        {
                                                                        ...
                                                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                                                                ...
                                                                                                <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
                                                                                                                        ...
                                                                                                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                                                                                                                                {teamGrowthPlannerData.roles.map(
                                                                                                                                                                        (
                                                                                                                                                                                                r,
                                                                                                                                                                                                idx
                                                                                                                                                                        ) => (
                                                                                                ...
                                                                                                <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
                                                                                                                        ...
                                                                                                                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2 text-xs">
                                                                                                                                                <div className="font-extrabold text-rose-400">
                                                                                                                                                                        {
                                                                                                                                                                                                monolithRiskData.verdict
                                                                                                                                                                        }
                                                                                                                                                </div>
                                                                                                                                                <p className="text-slate-300">
                                                                                                                                                                        {
                                                                                                                                                                                                monolithRiskData.coupling
                                                                                                                                                                        }
                                                                                                                                                </p>
