                        ...
                        const checkHealth = React.useCallback(async () => {
                                                ...
                                                try {
                                                                        ...
                                                                        if (res.ok) {
                                                                                                ...
                                                                                                addLog(
                                                                                                                        `[INFO] Checked health. Status: ${data.status}, Latency: ${latency}ms, Env: ${data.environment}`
                                                                                                );
                                                                        } else {
                                                                                                setHealth(
                                                                                                                        null
                                                                                                ...
                                                                                                addLog(
                                                                                                                        `[ERROR] Health check failed with HTTP status ${res.status}`
                                                                                                );
                                                                        }
                                                } catch (err) {
                                                                        setHealth(null);
                                                                        addLog(
                                                                                                `[CRITICAL] Network error: Failed to reach backend API endpoint.`
                                                                        );
                                                } finally {
                                                                        setLoading(false);
                                                }
                                                                                                ...
                                                                                                <div className="lg:col-span-7 border rounded-2xl bg-card p-6 shadow-sm space-y-4 flex flex-col">
                                                                                                                        ...
                                                                                                                        <div className="flex-1 min-h-[160px] bg-muted/20 border rounded-xl p-4 font-mono text-[10px] space-y-1.5 overflow-y-auto max-h-[220px]">
                                                                                                                                                ...
                                                                                                                                                0 ? (
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="text-muted-foreground/60 italic text-center py-12">
                                                                                                                                                                                                Console
                                                                                                                                                                                                listening
                                                                                                                                                                                                for
                                                                                                                                                                                                diagnostics...
