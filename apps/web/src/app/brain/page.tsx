...
export default function EngineeringBrainPage() {
                        ...
                        const [selectedService, setSelectedService] = useState<
                                                'Authentication Service' | 'Payment Gateway'
                        ...
                        const serviceBiographies: Record<
                                                string,
                                                {
                                                                        title: string;
                                                                        tagline: string;
                        ...
                        > = {
                                                'Authentication Service': {
                                                                        ...
                                                                        stages: [
                                                                                                {
                                                                                                                        stage: 1,
                                                                                                                        title: 'Created (Aug 2025)',
                                                                                                                        detail: 'Monolithic auth module inside FastAPI baseline core.',
                                                                                                                        badge: 'INCEPTION',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 2,
                                                                                                                        title: 'Reason (Why it Exists)',
                                                                                                                        detail: 'Centralized session verification & stateless JWT issuance.',
                                                                                                                        badge: 'PURPOSE',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 3,
                                                                                                                        title: 'First Deployment (Sept 2025)',
                                                                                                                        detail: 'Deployed to AWS EKS cluster on single Postgres node.',
                                                                                                                        badge: 'DEPLOY',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 4,
                                                                                                                        title: 'Major Refactor (Jan 2026)',
                                                                                                                        detail: 'PR #145 added Redis L2 cache, bypassing 14K DB queries/sec.',
                                                                                                                        badge: 'REFACTOR',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 5,
                                                                                                                        title: 'Incidents (Jan 2026)',
                                                                                                                        detail: 'INC-741 Token Latency Spike (SEV-2) resolved in 12m.',
                                                                                                                        badge: 'INCIDENT',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 6,
                                                                                                ...
                                                                                                },
                                                                                                {
                                                                                                                        ...
                                                                                                                        detail: 'Upgraded JWT signing keys to RS256 with automated rotation.',
                                                                                                                        badge: 'SECURITY',
                                                                                                },
                                                                                                {
                                                                                                                        stage: 8,
                                                                                                ...
                                                                                                },
                                                                                                {
                                                                                                                        ...
                                                                                                                        detail: 'Requires gRPC Token Vault decoupling within 12m for 45K QPS.',
                                                                                                                        badge: 'FUTURE',
                                                                                                },
                                                                        ],
                                                },
                                                ...
                                                if (
                                                                        ...
                                                                        setActiveQueryResult({
                                                                                                ...
                                                                                                sources: [
                                                                                                                        {
                                                                                                                                                type: 'COMMIT',
                                                                                                                                                title: 'feat(cache): Redis L2 Permission Cache (a1b2c3d4)',
                                                                                                                                                date: '2026-01-18',
                                                                                                                        },
                                                                                                                        {
                                                                                                                                                type: 'METRICS',
                                                ...
                                                <div className="min-h-screen bg-slate-950 text-slate-100 p-8 space-y-8">
                                                                                                                                                ...
                                                                                                                                                {serviceBiographies[
                                                                                                                                                                        ...
                                                                                                                                                                        (
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        className="bg-slate-900/90 p-3.5 rounded-xl border border-slate-800 space-y-1.5 hover:border-purple-500/40 transition-all"
                                                                                                                                                                                                >
                                                                        ...
                                                                        <div className="bg-gradient-to-br from-purple-950/40 via-slate-900 to-indigo-950/40 border border-purple-500/30 rounded-2xl p-6 shadow-2xl space-y-6">
                                                                                                ...
                                                                                                <div className="flex flex-wrap gap-2 text-xs">
                                                                                                                        <span className="text-slate-400 self-center font-bold">
                                                                                                                                                Sample
                                                                                                                                                Queries:
                                                                                                                        </span>
                                                                                                                        {presetQuestions.map(
                                                                                                                                                                                                ...
                                                                                                                                                                                                {activeQueryResult.sources.map(
                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <div
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        className="bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-lg flex items-center gap-2"
                                                                                                                                                                                                                                                >
                                                                                                ...
                                                                                                <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
                                                                                                                        ...
                                                                                                                        <div className="space-y-2 text-xs">
                                                                                                                                                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 flex justify-between items-center">
                                                                                                                                                                        <div>
                                                                                                                                                                                                <div className="font-bold text-white">
                                                                                                                                                                                                                        legacy-payment-gateway/crypto_utils.py
                                                                                                                                                                                                </div>
                                                                                                                                                ...
                                                                                                                                                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 flex justify-between items-center">
                                                                                                                                                                        <div>
                                                                                                                                                                                                <div className="font-bold text-white">
                                                                                                                                                                                                                        analytics-worker/batch_aggregator.py
                                                                                                                                                                                                </div>
