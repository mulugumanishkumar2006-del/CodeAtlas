...
const MOCK_FORECAST: ForecastSnapshot[] = [
                        {
                                                label: 'Current',
                                                score: 54.2,
                                                estimated_maintenance_cost: '$43,360 / month',
                        },
                        {
                                                label: '30 days',
                                                score: 62.3,
                                                estimated_maintenance_cost: '$49,840 / month',
                        },
                        {
                                                label: '90 days',
                                                score: 78.5,
                                                estimated_maintenance_cost: '$62,800 / month',
                        },
                        {
                                                label: '180 days',
                                                score: 99.1,
                                                estimated_maintenance_cost: '$79,280 / month',
                        },
];
...
const MOCK_EXECUTIVE_DASHBOARD: ExecutiveDashboard = {
                        ...
                        top_risky_services: [
                                                ...
                                                {
                                                                        file_path: 'packages/config/webpack.js',
                                                                        risk_score: 44.0,
                                                                        changes: 14,
                                                                        complexity: 21,
                                                },
                                                {
                                                                        file_path: 'packages/core/errors.ts',
                                                                        risk_score: 37.5,
                                                                        changes: 12,
                                                                        complexity: 18,
                                                },
                                                {
                                                                        file_path: 'apps/web/dashboard.tsx',
                                                                        risk_score: 37.3,
                                                                        changes: 7,
                                                                        complexity: 15,
                                                },
...
function computeSliceAndDice(
                        ...
                        for (const child of node.children) {
                                                ...
                                                const childRects = computeSliceAndDice(
                                                                        child,
                                                                        cx,
                                                                        cy,
                                                                        cw,
...
export default function TechnicalDebtPage() {
                        ...
                        const [scorecard, setScorecard] =
                                                React.useState<RiskScorecard>(MOCK_SCORECARD);
                        const [heatmap, setHeatmap] = React.useState<HeatmapNode>(MOCK_HEATMAP);
                        const [remediations, setRemediations] =
                                                React.useState<RemediationPlan[]>(
                                                                        MOCK_REMEDIATIONS
                                                );
                        const [aiAnalysis, setAiAnalysis] =
                                                React.useState<RepositoryAIDebtAnalysis>(
                                                                        MOCK_AI_ANALYSIS
                                                );

                        // Features 5, 6, 7 & 8 states
                        const [timeline, setTimeline] =
                                                React.useState<TimelineSnapshot[]>(MOCK_TIMELINE);
                        const [hotspots, setHotspots] =
                                                React.useState<HotspotsDetection>(MOCK_HOTSPOTS);
                        const [recommendations, setRecommendations] =
                                                React.useState<RefactoringRecommendation[]>(
                                                                        MOCK_RECOMMENDATIONS
                                                );
                        const [dashboardTrend, setDashboardTrend] =
                                                React.useState<HealthDashboardTrend>(
                                                                        MOCK_DASHBOARD_TREND
                                                );

                        // Features 9 & 10 states
                        const [forecast, setForecast] =
                                                React.useState<ForecastSnapshot[]>(MOCK_FORECAST);
                        const [riskExplanations, setRiskExplanations] =
                                                React.useState<RiskExplanation[]>(
                                                                        MOCK_RISK_EXPLANATIONS
                                                );

                        // Features 11 & 12 states
                        const [costOfDelay, setCostOfDelay] =
                                                React.useState<CostOfDelay>(MOCK_COST_OF_DELAY);
                        const [executiveDashboard, setExecutiveDashboard] =
                                                React.useState<ExecutiveDashboard>(
                        ...
                        const [selectedNode, setSelectedNode] = React.useState<HeatmapNode | null>(
                                                null
                        );
                        const [selectedRemediation, setSelectedRemediation] =
                                                React.useState<RemediationPlan | null>(null);
                        const [activeTabSide, setActiveTabSide] = React.useState<
                                                'checkpoints' | 'analyzer'
                        >('checkpoints');
                        ...
                        const fetchTechDebtData = React.useCallback(
                                                async (repoId: string) => {
                                                                        if (
                                                                                                !token ||
                                                                                                !repoId ||
                                                                        ...
                                                                        try {
                                                                                                const res =
                                                                                                                        await fetch(
                                                                                                                                                `/api/v1/repositories/${repoId}/tech-debt`,
                                                                                                                                                {
                                                                                                                                                                        headers: {
                                                                                                                                                                                                Authorization: `Bearer ${token}`,
                                                                                                                                                                        },
                                                                                                ...
                                                                                                if (
                                                                                                                        ...
                                                                                                                        setError(
                                                                                                                                                errData.detail ||
                                                                                                                                                                        'Failed to fetch technical debt data'
                                                                                                                        );
                                                                                                                        setSummary(
                                                                                                                                                MOCK_SUMMARY
                                                                                                                        );
                                                                                                ...
                                                                                                console.error(
                                                                                                                        'Fetch tech debt failed',
                                                                                                                        e
                                                                                                );
                                                                                                setError(
                                                                                                                        'Network connection error. Displaying demo model.'
                                                                                                );
                                                                                                setSummary(
                                                                                                                        MOCK_SUMMARY
                                                                                                );
                        ...
                        const handleSelectNode = (node: HeatmapNode) => {
                                                ...
                                                const matchedPlan = remediations.find(
                                                                        (r) =>
                                                                                                r.file_path ===
                                                                                                node.path
                                                );
                                                if (matchedPlan) {
                                                                        ...
                                                                        setSelectedRemediation({
                                                                                                ...
                                                                                                reasons: [
                                                                                                                        ...
                                                                                                                        node.has_long_methods
                                                                                                                                                ? 'Contains long methods with excessive LOC'
                                                                                                                                                : '',
                                                                                                                        node.has_god_classes
                                                                                                                                                ? 'Identified as a God Class holding excessive responsibility'
                                                                                                                                                : '',
                                                                                                                        node.is_cyclic
                                                                                                                                                ? 'Involved in circular dependency loop'
                                                                                                                                                : '',
                                                                                                ].filter(
                                                                                                                        Boolean
                                                                                                ),
                                                                                                ...
                                                                                                causing_dependencies: node.has_high_coupling
                                                                                                                        ? [
                        ...
                        const handleLocateTarget = (targetPath: string) => {
                                                const fileNode = rects.find(
                                                                        (r: any) =>
                                                                                                r
                                                                                                                        .node
                                                                                                                        .path ===
                                                                                                                        targetPath ||
                                                                                                r.node.path.endsWith(
                                                                                                                        targetPath
                                                                                                )
                                                )?.node;
                                                if (fileNode) {
                        ...
                        const getRiskColor = (score: number) => {
                                                if (score > 80)
                                                                        return 'bg-red-500/20 text-red-400 border-red-500/35 hover:bg-red-500/30';
                                                if (score > 60)
                                                                        return 'bg-orange-500/20 text-orange-400 border-orange-500/35 hover:bg-orange-500/30';
                                                if (score > 35)
                                                                        return 'bg-amber-500/20 text-amber-400 border-amber-500/35 hover:bg-amber-500/30';
                                                                        ...
                                                                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                                                                <div>
                                                                                                                        <div className="flex items-center gap-2">
                                                                                                                                                <h1 className="text-3xl font-extrabold tracking-tight text-foreground animate-in fade-in slide-in-from-left-1 duration-200">
                                                                                                                                                                        Risk
                                                                                                                                                                        Heatmap
                                                                                                                                                </h1>
                                                                                                                                                ...
                                                                                                                                                <div className="md:col-span-3 rounded-2xl border bg-background/40 p-5 shadow-sm border-border/70 backdrop-blur-sm">
                                                                                                                                                                        <div className="flex items-center justify-between border-b border-border/40 pb-2 mb-4">
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="flex items-center gap-4 text-[9px] font-bold text-muted-foreground">
                                                                                                                                                                                                                        {dashboardTrend.trend_labels.map(
                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                                        lbl,
                                                                                                                                                                                                                                                                        i
                                                                                                                                                                                                                                                ) => (
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="grid gap-6 grid-cols-2 lg:grid-cols-4">
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="bg-card/40 border border-border/50 rounded-xl p-3 flex flex-col justify-between">
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div className="flex justify-center py-2.5">
                                                                                                                                                                                                                                                <Sparkline
                                                                                                                                                                                                                                                                        data={
                                                                                                                                                                                                                                                                                                dashboardTrend.complexity_trend
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                        color="#f59e0b"
                                                                                                                                                                                                                                                />
                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="bg-card/40 border border-border/50 rounded-xl p-3 flex flex-col justify-between">
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div className="flex justify-center py-2.5">
                                                                                                                                                                                                                                                <Sparkline
                                                                                                                                                                                                                                                                        data={
                                                                                                                                                                                                                                                                                                dashboardTrend.dependency_growth
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                        color="#6366f1"
                                                                                                                                                                                                                                                />
                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <div className="flex items-center gap-4">
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                <div className="flex flex-col items-end border-l pl-3">
                                                                                                                                                                                                                                                                                                                                                                        <span className="text-xs font-mono font-semibold text-foreground">
                                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                                                        snap.estimated_maintenance_cost
                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                        </span>
                                                                                                                                                                                                                                                                                                                                                                        <span className="text-[9px] font-bold text-muted-foreground">
                                                                                                                                                                                                                                                                                                                                                                                                Maint.
                                                                                                                                                                                                ...
                                                                                                                                                                                                {riskExplanations.map(
                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <div
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        className="rounded-xl border border-red-500/15 bg-red-500/5 p-4 space-y-2 hover:bg-red-500/10 transition-colors"
                                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                {expl.reasons.map(
                                                                                                                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                <li
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        className="flex items-start gap-2 text-xs text-foreground/80 leading-normal"
                                                                                                                                                                                                                                                                                                                                                >
                                                                                                                                                ...
                                                                                                                                                <div className="rounded-2xl border bg-background/40 p-6 shadow-sm border-border/70 backdrop-blur-sm lg:col-span-2 relative">
                                                                                                                                                                        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="flex flex-wrap items-center gap-3 text-[10px] font-bold uppercase tracking-wider">
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <span className="flex items-center gap-1">
                                                                                                                                                                                                                                                <span className="h-3 w-3 rounded-full bg-orange-500/20 border border-orange-500/40" />{' '}
                                                                                                                                                                                                                                                🟠
                                                                                                                                                                                                                                                High
                                                                                                                                                                                                                                                Risk
                                                                                                                                                                                                                        </span>
                                                                                                                                                                                                                        <span className="flex items-center gap-1">
                                                                                                                                                                                                                                                <span className="h-3 w-3 rounded-full bg-red-500/25 border border-red-500/45 animate-pulse" />{' '}
                                                                                                                                                                                                                                                🔴
                                                                                                                                                                                                                                                Critical
                                                                                                                                                                                                                        </span>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                                                                                                        <rect
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                className={cn(
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        fillClass,
                                                                                                                                                                                                                                                                                                                                                                        isSelected
                                                                                                                                                                                                                                                                                                                                                                                                ? 'stroke-foreground stroke-2 scale-[0.99] shadow-inner'
                                                                                                                                                                                                                                                                                                                                                                                                : 'stroke-transparent hover:brightness-110'
                                                                                                                                                                                                                                                                                                                                                )}
                                                                                                                                                                                                                                                                                                                        />
                                                                                                                                                                                                                                                                                                                        {width >
                                                                                                                                                                                                                                                                                                                                                60 &&
                                                                                                                                                                                                                                                                                                                                                height >
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                                                                                                                                                                <div className="flex h-full flex-col justify-between p-0.5 text-left leading-none">
                                                                                                                                                                                                                                                                                                                                                                                                                        <span className="text-[10px] sm:text-xs font-bold truncate text-foreground/90">
                                                                                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        node.name
                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                                                        </span>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                'checkpoints' ? (
                                                                                                                                                                                                                                                                        <div className="space-y-1.5 animate-in fade-in duration-200">
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <div className="flex items-center justify-between text-xs py-0.5">
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <span className="font-semibold text-foreground">
                                                                                                                                                                                                                                                                                                                                                {selectedNode.cognitive_complexity ||
                                                                                                                                                                                                                                                                                                                                                                        0}
                                                                                                                                                                                                                                                                                                                        </span>
                                                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                                                <div className="flex items-center justify-between text-xs py-0.5">
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <div className="flex items-center justify-between text-xs py-0.5">
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <span
                                                                                                                                                                                                                                                                                                                                                className={cn(
                                                                                                                                                                                                                                                                                                                                                                        'text-xs font-bold',
                                                                                                                                                                                                                                                                                                                                                                        selectedNode.has_duplicate_code
                                                                                                                                                                                                                                                                                                                                                                                                ? 'text-orange-400'
                                                                                                                                                                                                                                                                                                                                                                                                : 'text-emerald-400'
                                                                                                                                                                                                                                                                                                                                                )}
                                                                                                                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        selectedRemediation && (
                                                                                                                                                                                                                                                                                                <div className="space-y-3 text-xs animate-in fade-in duration-200">
                                                                                                                                                                                                                                                                                                                        <div className="space-y-1 border-l-2 border-indigo-500 pl-2.5">
                                                                                                                                                                                                                                                                                                                                                <span className="font-bold text-indigo-500 uppercase tracking-wider text-[10px] block">
                                                                                                                                                                                                                                                                                                                                                                        Why
                                                                                                                                                                                                                                                                                                                                                                        Debt
                                                                                                                                                                                                                                                                                                                                                                        Exists
                                                                                                                                                                                                                                                                                                                                                </span>
                                                                                                                                                                                                                                                                                                                                                <p className="text-foreground/80 leading-relaxed">
                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                                                selectedRemediation.why_debt_exists
                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                </p>
                                                                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                                        <div className="space-y-1 border-l-2 border-indigo-500 pl-2.5">
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                <p className="text-foreground/80 leading-relaxed">
                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                                                selectedRemediation.why_debt_increased
                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                </p>
                                                                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                                        <div className="space-y-1 border-l-2 border-indigo-500 pl-2.5">
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                <div className="flex flex-wrap gap-1 mt-1">
                                                                                                                                                                                                                                                                                                                                                                        {selectedRemediation.causing_dependencies.map(
                                                                                                                                                                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                                                                                                                                                                                        dep,
                                                                                                                                                                                                                                                                                                                                                                                                                        i
                                                                                                                                                                                                                                                                                                                                                                                                ) => (
                                                                                                                                                                                                                                                                                                                                                                                                                        <span
                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                className="inline-flex rounded px-1.5 py-0.5 font-mono text-[9px] font-bold bg-muted border text-muted-foreground"
                                                                                                                                                                                                                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        dep
                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <div className="space-y-1 border-l-2 border-indigo-500 pl-2.5">
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                <p className="text-foreground/80 leading-normal font-semibold">
                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                                                selectedRemediation.how_to_reduce
                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                </p>
                                                                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                        ...
                                                                                                                                                                        {recommendations.map(
                                                                                                                                                                                                (
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                className="flex flex-col justify-between rounded-xl border bg-card/50 p-5 shadow-sm border-border/80"
                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                <div>
                                                                                                                                                                                                                                                                        <div className="flex items-start justify-between border-b pb-3 mb-3 border-border/60">
                                                                                                                                                                                                                                                                                                <div className="flex flex-col gap-0.5 max-w-[70%]">
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <span
                                                                                                                                                                                                                                                                                                                                                className="text-[10px] font-mono text-muted-foreground truncate cursor-pointer hover:text-foreground"
                                                                                                                                                                                                                                                                                                                                                onClick={() =>
                                                                                                                                                                                                                                                                                                                                                                        handleLocateTarget(
                                                                                                                                                                                                                                                                                                                                                                                                rec.target
                                                                                                                                                                                                                                                                                                                                                                        )
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        <div className="space-y-2 text-xs leading-normal">
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <p className="text-amber-500/90 font-semibold">
                                                                                                                                                                                                                                                                                                                        Risks:{' '}
                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                rec.risks
                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <div className="border-t pt-3 mt-4 flex items-center justify-between text-xs font-semibold text-muted-foreground">
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        <span
                                                                                                                                                                                                                                                                                                className="text-foreground/80 flex items-center gap-1 cursor-pointer"
                                                                                                                                                                                                                                                                                                onClick={() =>
                                                                                                                                                                                                                                                                                                                        handleLocateTarget(
                                                                                                                                                                                                                                                                                                                                                rec.target
                                                                                                                                                                                                                                                                                                                        )
                                                                                                ...
                                                                                                <div className="space-y-6 animate-in fade-in duration-200">
                                                                                                                        <div className="grid gap-6 md:grid-cols-3">
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <svg className="h-32 w-32 transform -rotate-90">
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        <circle
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                strokeDashoffset={
                                                                                                                                                                                                                                                                                                                        339 -
                                                                                                                                                                                                                                                                                                                        (339 *
                                                                                                                                                                                                                                                                                                                                                executiveDashboard.overall_health) /
                                                                                                                                                                                                                                                                                                                                                100
                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                strokeLinecap="round"
                                                                                                                                                                                                                                                                        />
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="space-y-3.5 text-xs">
                                                                                                                                                                                                                        <div className="flex justify-between items-center border-b border-indigo-500/5 pb-2">
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <span className="font-extrabold text-foreground">
                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                costOfDelay.time_lost_per_sprint
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                </span>
                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div className="flex justify-between items-center border-b border-indigo-500/5 pb-2">
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <span className="font-extrabold text-foreground">
                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                costOfDelay.refactoring_effort
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                </span>
                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div className="flex justify-between items-center">
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <span className="font-extrabold text-emerald-400">
                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                costOfDelay.long_term_maintenance_cost
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                </span>
                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                </div>
                                                                                                                                                ...
                                                                                                                                                <div className="rounded-2xl border bg-background/40 p-6 shadow-sm border-border/70 backdrop-blur-sm space-y-4">
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="space-y-3.5 text-xs">
                                                                                                                                                                                                {Object.entries(
                                                                                                                                                                                                                        executiveDashboard.team_debt_distribution
                                                                                                                                                                                                ).map(
                                                                                                                                                                                                                        ([
                                                                                                                                                                                                                                                subsystem,
                                                                                                                                                                                                                                                val,
                                                                                                                        ...
                                                                                                                        <div className="grid gap-6 lg:grid-cols-3">
                                                                                                                                                ...
                                                                                                                                                <div className="rounded-2xl border bg-background/40 p-6 shadow-sm border-border/70 backdrop-blur-sm lg:col-span-2 space-y-4">
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="overflow-x-auto">
                                                                                                                                                                                                <table className="w-full text-xs text-left border-collapse">
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <tbody>
                                                                                                                                                                                                                                                {executiveDashboard.top_risky_services.map(
                                                                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                                                                srv,
                                                                                                                                                                                                                                                                                                idx
                                                                                                                                                                                                                                                                        ) => (
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                                                                                                        <td className="py-3 font-mono font-semibold max-w-[280px] truncate text-foreground/90">
                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                        srv.file_path
                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                        </td>
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        <td className="py-3 text-center font-bold text-foreground/80">
                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                        srv.changes
                                                                                                                                                                                                                                                                                                                                                }{' '}
                                                                                                                                                                                                                                                                                                                                                commits
                                                                                                                                                ...
                                                                                                                                                <div className="rounded-2xl border bg-background/40 p-6 shadow-sm border-border/70 backdrop-blur-sm space-y-4">
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="space-y-4">
                                                                                                                                                                                                {executiveDashboard.high_priority_fixes.map(
                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                fix,
                                                                                                                                                                                                                                                idx
                                                                                                                                                                                                                        ) => (
