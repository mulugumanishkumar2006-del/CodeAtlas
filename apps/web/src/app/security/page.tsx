...
export default function SecurityPage() {
                        ...
                        const parsedJwt = React.useMemo(() => {
                                                ...
                                                try {
                                                                        ...
                                                                        console.error(
                                                                                                'Failed to parse local authentication token payload',
                                                                                                e
                                                                        );
                                                }
                                                return null;
                        ...
                        const handleStartScan = () => {
                                                ...
                                                const steps = [
                                                                        {
                                                                                                msg: 'Loading dependency manifests...',
                                                                                                time: 1000,
                                                                        },
                                                                        {
                                                                                                msg: 'Analyzing requirements.txt (FastAPI Backend)...',
                                                                                                time: 2000,
                                                                        },
                                                                        {
                                                                                                msg: 'Analyzing package.json (Next.js Frontend)...',
                                                                                                time: 3000,
                                                                        },
                                                                        {
                                                                                                msg: 'Scanning ast_service.py for static inputs...',
                                                                                                time: 4000,
                                                                        },
                                                                        {
                                                                                                msg: 'Auditing configuration settings files...',
                                                                                                time: 5000,
                                                                        },
                                                                        {
                                                                                                msg: 'Finalizing security assessment report...',
                                                                                                time: 6000,
                                                                        },
                                                ];
